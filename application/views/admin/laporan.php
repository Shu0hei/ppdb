        ...
        <div class="row">
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="card-body">
                <a href="<?php echo $url_cetak; ?>" class=" btn btn-danger mb-3"><i class="fas fa-file-pdf"></i>CETAK
                  PDF</a>
                <a href="<?php echo $url_excel; ?>" class=" btn btn-success mb-3"><i class="fas fa-file-excel"></i>CETAK
                  EXCEL</a>
