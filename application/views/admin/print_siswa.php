...
$pdf->SetX(8);
$pdf->MultiCell(19.5, 0.7, "SDN Galeh Manurung", 0, 'C');
$pdf->SetFont('Times', '', 12);
$pdf->SetX(8);
$pdf->MultiCell(19.5, 0.7, 'Desa Cicadas, Kec. Gunung Putri, Kab. Bogor, Prov. Jawa Barat, Kode Pos 16964
', 0, 'C');
...
$pdf->Output("Laporan Siswa Diterima.pdf", "I");
