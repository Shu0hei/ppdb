              ...
              <table id="datatable" class="display table table-striped table-hover">
                ...
                <tbody class="center">
                  ...
                  foreach ($verivikasi as $a) { ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-button-action">
                          <a href="<?= base_url('admin/detail_siswa/' . $a->no_pendaftaran . '') ?>" type="button"
                            title="Detail Data Siswa" class="btn btn-link btn-primary btn-lg">
                            <i class="fa fa-info-circle"></i>
                          </a>
                          <?php if ($a->id_verivikasi == 2) { ?>
                            <a onclick="deleteConfirm('<?php echo site_url('admin/acc_siswa/' . $a->no_pendaftaran) ?>')"
                              type="button" title="Setuju Data Siswa" class="btn btn-link btn-primary btn-lg">
                              <i class="fa fa-check"></i>
                            </a>
                          <?php } elseif ($a->id_verivikasi == 1) { ?>
                            <a onclick="deleteConfirmbatal('<?php echo site_url('admin/batal_siswa/' . $a->no_pendaftaran) ?>')"
                              type="button" title="Batal Verivikasi Data Siswa" class="btn btn-link btn-danger btn-lg">
                              <i class="fa fa-minus"></i>
                            </a>

                          <?php } ?>
                          <a onclick="deleteConfirmhapus('<?php echo site_url('admin/tidterima_siswa/' . $a->no_pendaftaran) ?>')"
                            type="button" title="Siswa Tidak Di Terima" class="btn btn-link btn-danger btn-lg">
                    ...
                    <div class="modal fade" id="deleteModal-batal" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                          ...
                          <div class="modal-body">Jika ada siswa yang data pemberkasan tidak sesuai silahkan Batalkan
                            verivikasi.</div>
                          <div class="modal-footer">
                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Kembali</button>
                    ...
                    <div class="modal fade" id="deleteModal-hapus" tabindex="-1" role="dialog"
                      aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
