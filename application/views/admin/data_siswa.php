        ...
        <div class="row">
                ...
                <div class="card ">
                  ...
                  <div class="collapse show" id="dataall">
                    <div class="card-body" style="text-align: center;">
                      <?php foreach ($detail_siswa as $u) { ?>
                        <a href="<?= base_url('assets/foto/scan/' . $u->ktp) ?>" target="_blank"
                          class="btn btn-primary btn-round ml-auto">Show KTP Pdf</a>
                        <a href=" <?= base_url('assets/foto/scan/' . $u->kk) ?>" target="_blank"
                          class="btn btn-info btn-round ml-auto">Show KK Pdf</a>
                        <a href=" <?= base_url('assets/foto/scan/' . $u->akta) ?>" target="_blank"
                          class="btn btn-warning btn-round ml-auto">Show AKTA Pdf</a>
                      <?php } ?>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-6">
            ...
            <div class="d-flex align-items-center">
              ...
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              <a href="<?= base_url('dashboard') ?>" class="btn btn-primary btn-round ml-auto" style="color: white;">
              ...
              <a href="<?= base_url('admin/reset_password/' . $get_id->no_pendaftaran) ?>"
                class="btn btn-danger btn-round ml-auto" style="color: white;">
