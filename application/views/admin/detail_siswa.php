        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-12">
                <br><br> <br>
                <div class="card ">
                  <a href="#dataall" class="d-block bg-danger border border-danger card-header py-3"
                    data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample"
                      ...
                      <?php } else { ?>
                        <?php foreach ($detail_siswa as $u) { ?>
                          <button type="button" class="btn btn-primary btn-round ml-auto" data-toggle="modal"
                            data-target=".bd-example-modal-lg">Show KTP</button>
                          <button type="button" class="btn btn-info btn-round ml-auto" data-toggle="modal"
                            data-target=".bd-example-modal-lg-kk">Show KK</button>
                          <button type="button" class="btn btn-warning btn-round ml-auto" data-toggle="modal"
                            data-target=".bd-example-modal-lg-akta">Show AKTA</button>
                        <?php } ?>
                      <?php } ?>
                    </div>
                  </div>
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content ktp">
                        ...
                        <div class="modal-body">
                          <?php foreach ($detail_siswa as $u) { ?>
                            <iframe src="<?= base_url('assets/foto/scan/' . $u->ktp) ?>" style="height: 600px;"
                              class="col-lg-12 col-md-12 col-sm-12"></iframe>
                          <?php } ?>
                        </div>
                      </div>
                  ...
                  <div class="modal fade bd-example-modal-lg-kk" tabindex="-1" role="dialog"
                    aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content ktp">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <?php foreach ($detail_siswa as $u) { ?>
                            <iframe src="<?= base_url('assets/foto/scan/' . $u->kk) ?>" style="height: 600px;"
                              class="col-lg-12 col-md-12 col-sm-12"></iframe>
                          <?php } ?>
                        </div>
                      </div>
                  ...
                  <div class="modal fade bd-example-modal-lg-akta" tabindex="-1" role="dialog"
                    aria-labelledby="myLargeModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content ktp">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          <?php foreach ($detail_siswa as $u) { ?>
                            <iframe src="<?= base_url('assets/foto/scan/' . $u->akta) ?>" style="height: 600px;"
                              class="col-lg-12 col-md-12 col-sm-12"></iframe>
                          <?php } ?>
                        </div>
                      </div>
          ...
          <div class="col-md-6">
            ...
            <div class="d-flex align-items-center">
              ...
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp;
              <a href="<?= base_url('admin/verivikasi') ?>" class="btn btn-primary btn-round ml-auto"
                style="color: white;">
                <i class="fa fa-minus"></i>
                Kembali
              </a>
              <a href="<?= base_url('admin/cetak_siswa/' . $get_id->no_pendaftaran) ?>"
                class="btn btn-warning btn-round ml-auto" style="color: white;">
                <i class="fa fa-print"></i>
                Cetak
              </a>
              <a href="#!"
                onclick="deleteConfirm('<?php echo site_url('admin/delete_all_datasiswa/' . $get_id->no_pendaftaran) ?>')"
                class="btn btn-danger btn-round ml-auto"><i class="fa fa-times"> Hapus data</i></a>
            </div>
            <br>

            <div class="card">
              <a href="#datapriodik" class="d-block bg-warning border border-warning card-header py-3"
                data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
            ...
            <div class="card">
              <a href="#dataayah" class="d-block bg-primary border border-primary card-header py-3"
                data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
            ...
            <div class="card">
              <a href="#dataibu" class="d-block bg-info border border-info card-header py-3" data-toggle="collapse"
            ...
            <div class="card">
              <a href="#datawali" class="d-block bg-warning border border-warning card-header py-3"
                data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                <h6 class="m-0 font-weight-bold text-white"> Data Wali</h6>
              </a>
