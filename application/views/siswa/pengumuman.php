        ...
        <div class="row">
            ...
            <?php if ($cek->status_pendaftaran == 'lulus') { ?>
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <h3>
                            <center>
                                Selamat <b></b> <span class="label label-success" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru <b>SMA Negeri 1 Belitang</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
                                <hr>
            ...
            <?php } else { ?>
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <h3>
                            <center>~ Belum ada Pengumuman dari Panitia PPDB Online SMA Negeri 1 Belitang ~</center>
                        </h3>
                    </div>
                </div>
            <?php } ?>
