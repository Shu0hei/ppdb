                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="<?= base_url('frontend/index') ?>">
                            <img src="<?= base_url('assets/frontend/foto/logo') ?>/logo sd1.png" alt="Logo" style="width: 50%;">
                        </a>
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="page-scroll" href="<?= base_url('frontend/index') ?>">Tentang Sekolah</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="#services">Informasi</a>
                                </li>
                                <li class="nav-item">
                                    <a class="page-scroll" href="<?= base_url('login/login_siswa') ?>">Login</a>
                                </li>
            ...
            <div class="row space-100">
                <div class="col-lg-6 col-md-12 col-xs-12">
                    <div class="contents">
                        ...
                        <h2>Form Pendaftaran PPDB Online <strong>SDN Galeh Manurung</strong></h2>
                            ...
                            <div class="tab-content" id="main_form">
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    <div class="row" style="margin-left: 40px">
                                        <h2 style="font-size: 30px;">Kententuan PPDB <strong class="" style="color:#4374fb; ">SDN Galeh Manurung</strong></h2>
                                        <div class="panel-body">

                                            <ol style="color:#333;">

                                                <li>Setiap calon peserta didik baru wajib mengisi form pendaftaran dengan lengkap. </li>

                                                <li>Bagi Calon peserta didik baru per 1 juli minimal berusia 4 tahun. </li>
                                                ...
                                                <li>Calon peserta didik baru yang sudah mendaftarkan secara online akan mendapatkan Nomor Pendaftaran yang harus dicetak dan dilampirkan dalam persyaratan yang diminta oleh Panitia PPDB SDN Galeh Manurung. </li>

                                                <li>Calon peserta didik baru yang sudah mendaftarkan diri melalui PPDB Online SDN Galeh Manurung akan mendapatkan Nomor Pendaftaran dan Password default (123456) yang nantinya akan digunakan untuk akses informasi yang berkaitan dengan PPDB SDN Galeh Manurung.</li>

                                                <li>Calon peserta didik baru yang sudah mendaftarakan diri melalui PPDB Online SDN Galeh Manurung dan dinyatakan lulus pemberkasan, dapat bergabung digrup whatshapp (link grup dilampirkan dipengumuman).</li>

                                                <li>Calon peserta didik baru yang sudah mendaftarakan diri melalui PPDB Online SDN Galeh Manurung dan dinyatakan lulus pemberkasan WAJIB menyerahkan dokumen persyaratan yang sudah ditentukan oleh Panitia PPDB SDN Galeh Manurung sesuai informasi di grup whatshapp PPDB.</li>

                                                <li>Data yang sudah diberikan oleh Panitia PPDB SDN Galeh Manurung hanya digunakan untuk keperluan penerimaan siswa baru dan <strong class="text-danger">data tidak akan dipublikasikan serta dijaga kerahasiaannya oleh Panita PPDB</strong>.</li>

                                            </ol>
                                        </div>
                                    </div>
                                    <ul class="list-inline pull-right">
                                        <li><button type="button" class="default-btn next-step">Lanjut</button></li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="golongan" class="form-control" id="golongan">
                                                    ...
                                                    <option value="A">Kurang Dari 5 tahun</option>
                                                    <option value="B">Lebih Dari 5 tahun</option>
                                                </select>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step4">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label>Pekerjaan</label>
                                                                <select class="form-control" name="pekerjaan" id="pekerjaan">
                                                                    <option value="">Pili Pekerjaan Wali</option>
                                                                    <option value="buruh">Buruh</option>
                                                                    <option value="tani">Tani</option>
                                                                    <option value="wiraswasta">Wiraswasta</option>
                                                                    <option value="pns">PNS</option>
                                    ...
                                    <ul class="list-inline pull-right">
                                        <li><button type="button" class="default-btn prev-step">Kembali</button></li>
                                        <li><button type="submit" class="default-btn next-step">Selesai</button></li>
                                    </ul>
                                </div>
                                <div class="clearfix">
