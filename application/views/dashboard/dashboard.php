...
<?php } elseif ($this->session->userdata['id_level'] == 2) { ?>
    <div class="main-panel">
        <div class="content">
            ...
            <div class="row">
                <div class="card-body">
                    <div class="card shadow mb-4 border-bottom-success" style="text-align: center;" id="infosantri"
                        value="0">
                        ...
                        <div class="collapse show" id="informasisantri">
                            <?php if ($ver_siswa->id_verivikasi == 2) { ?>
                                <H3>Belum Ada Pengumuman Terkait Kelulusan, Silahkan lengkapi berkas AKTA, KTP Orang tua dan KK.
                                    Jika ada yang ditanyakan silahkan hubungi admin sekolah </H3>
                                <div class="list-content">
                                    <a href="#listthree" class="d-block bg-primary border border-primary card-header py-3"
                                        ...
                                        <div class="collapse" id="listthree">
                                            <div class="list-box">
                                                <?php if ($ver_siswa->ktp == null) { ?>
                                                    <form role="form" action="<?= base_url('admin/update_ktp') ?>" class="login-box"
                                                        enctype="multipart/form-data" method="POST">
                                                        <div class="row">
                                                            <input class="form-control" type="text" name="no_pendaftaran" placeholder=""
                                                                value="<?= $ver_siswa->no_pendaftaran ?>" hidden>
                                                            <div class="col-md-12">
                                                ...
                                                <?php } elseif ($ver_siswa->kk == null) { ?>
                                                    ...
                                                    <form role="form" action="<?= base_url('admin/update_kk') ?>" class="login-box"
                                                        enctype="multipart/form-data" method="POST">
                                                        <div class="row">
                                                            <input class="form-control" type="text" name="no_pendaftaran" placeholder=""
                                                                value="<?= $ver_siswa->no_pendaftaran ?>" hidden>
                                                ...
                                                <?php } elseif ($ver_siswa->akta == null) { ?>
                                                    <form role="form" action="<?= base_url('admin/update_akta') ?>" class="login-box"
                                                        enctype="multipart/form-data" method="POST">
                                                        <div class="row">
                                                            <input class="form-control" type="text" name="no_pendaftaran" placeholder=""
                                                                value="<?= $ver_siswa->no_pendaftaran ?>" hidden>
                            ...
                            <div class="card-body">
                                <H3>Mohon Maaf Kepada <?= $this->session->userdata['full_name'] ?>, Anda dinyatakan
                                    <?php if ($ver_siswa->id_verivikasi == 3) { ?>
                                        <a type="text" style="font-size: 20px; color: black; font-weight: 50px;">BELUM LULUS
                                            PEMBERKASAN</a> Untuk info lebih lanjut silahkan hubungi admin PPDB SDN Galeh Manurung
                            ...
                            <div class="card-body">
                                <H3>Selamat Kepada <?= $this->session->userdata['full_name'] ?>, Anda dinyatakan
                                    <?php if ($ver_siswa->id_verivikasi == 1) { ?>
                                        <a type="text" style="font-size: 20px; color: black; font-weight: 50px;">LULUS
                                            PEMBERKASAN</a>
                                        <h3>Silahkan Masuk Link Grup <h3><a href="https://chat.whatsapp.com/BkutNr3v7C71fjEwkFn56a"
                                                    style="color: #25D366;">Whatsapp</a></h3>
                                        </h3>
                                    <?php } ?>
                                </H3>
                                <div class="card-body">
                                ...
                                <h3>Pembayaran administrasi diatas dilakukan setelah masuk sekolah. Info lebih lanjut dapat
                                    dipantau di grup WA PPDB SDN Galeh Manurung</h3>
                            </div>
                        <?php } ?>
